...
import { JobWithCompany, JobWithCompanyFromJSON, JobWithCompanyToJSON, SearchJobDto, SearchJobDtoFromJSON, SearchJobDtoToJSON } from '../models';
...
export class JobsApi extends runtime.BaseAPI {
	...
	async jobsControllerGetJobsByIdRaw(requestParameters: JobsControllerGetJobsByIdRequest): Promise<runtime.ApiResponse<Array<JobWithCompany>>> {
		if (requestParameters.requestBody === null || requestParameters.requestBody === undefined) {
			throw new runtime.RequiredError(
				'requestBody',
				'Required parameter requestParameters.requestBody was null or undefined when calling jobsControllerGetJobsById.'
			);
		}
	...
	async jobsControllerSearchJobsRaw(requestParameters: JobsControllerSearchJobsRequest): Promise<runtime.ApiResponse<Array<JobWithCompany>>> {
		if (requestParameters.searchJobDto === null || requestParameters.searchJobDto === undefined) {
			throw new runtime.RequiredError(
				'searchJobDto',
				'Required parameter requestParameters.searchJobDto was null or undefined when calling jobsControllerSearchJobs.'
			);
		}
